...
#define TIMER_PRESCALER_2   1
#define TIMER_PRESCALER_4   3
#define TIMER_PRESCALER_8   7
#define TIMER_PRESCALER_16  15
...
#define TIMER_EvSrc_ETR_TRAIL                 (((uint32_t)0x9) << TIMER_CNTRL_EVENT_SEL_Pos)  /*!< Selects ETR event. */
#define TIMER_EvSrc_TM4                       (((uint32_t)0xA) << TIMER_CNTRL_EVENT_SEL_Pos)  /*!< Selects TIMER4 (CNT == ARR) event. */
...
#define TIMER_IT_CNT_ZERO_EVENT 0x00000001
#define TIMER_IT_CNT_ARR_EVENT  0x00000002
