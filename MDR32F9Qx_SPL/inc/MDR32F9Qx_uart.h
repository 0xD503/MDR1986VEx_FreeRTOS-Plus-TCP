...
#define UART_IT_ERROR                       ((uint32_t)0x000007C0)
...
#define UART_IFLS_LVL_MASK                  ((uint16_t)0x003F)

#define UART_TXIFLSEL_1_8                   ((uint16_t)0x0000)
#define UART_TXIFLSEL_1_4                   ((uint16_t)0x0001)
#define UART_TXIFLSEL_1_2                   ((uint16_t)0x0002)
#define UART_TXIFLSEL_3_4                   ((uint16_t)0x0003)
#define UART_TXIFLSEL_7_8                   ((uint16_t)0x0004)

#define UART_RXIFLSEL_1_8                   ((uint16_t)0x0000)
#define UART_RXIFLSEL_1_4                   ((uint16_t)0x0008)
#define UART_RXIFLSEL_1_2                   ((uint16_t)0x0010)
#define UART_RXIFLSEL_3_4                   ((uint16_t)0x0018)
#define UART_RXIFLSEL_7_8                   ((uint16_t)0x0020)
